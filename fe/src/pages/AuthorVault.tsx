    ...
    <div style={{ display: 'flex', minHeight: '100vh', fontFamily: 'sans-serif', backgroundColor: '#f8fafc' }}>
      ...
      <div style={{ width: '250px', backgroundColor: '#0f172a', color: 'white', padding: '20px' }}>
        ...
        <nav style={{ display: 'flex', flexDirection: 'column', gap: '10px', marginTop: '30px' }}>
          ...
          <Link to="/admin/authors" style={{ color: 'white', textDecoration: 'none' }}>✍️ Manage Authors</Link>
          <Link to="/admin/author-vault" style={{ color: '#38bdf8', textDecoration: 'none' }}>🗄️ Author Vault</Link>
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '14px', textAlign: 'left' }}>
            ...
            <tbody>
              {loading ? <tr><td colSpan={4} style={{ padding: '20px', textAlign: 'center' }}>Loading...</td></tr> : 
                archives.length === 0 ? <tr><td colSpan={4} style={{ padding: '20px', textAlign: 'center' }}>Vault empty.</td></tr> :
                archives.map(arc => {
                  ...
                  return (
                    <tr key={arc.archive_id} style={{ borderBottom: '1px solid #e2e8f0' }}>
                      ...
                      <td style={{ padding: '15px 20px' }}><strong>{payload.first_name} {payload.last_name}</strong></td>
