    ...
    <div style={{ display: 'flex', minHeight: '100vh', backgroundColor: '#f8fafc', fontFamily: 'sans-serif' }}>
      ...
      <div style={{ width: '250px', backgroundColor: '#0f172a', color: 'white', padding: '20px' }}>
        ...
        <nav style={{ display: 'flex', flexDirection: 'column', gap: '10px', marginTop: '30px' }}>
          ...
          <Link to="/admin/members" style={{ color: '#38bdf8', textDecoration: 'none' }}>👤 Manage Members</Link>
          <button 
            onClick={handleLogout} 
            style={{ marginTop: '50px', backgroundColor: '#ef4444', border: 'none', padding: '10px', color: 'white', cursor: 'pointer', borderRadius: '4px' }}
          >
            Logout
          </button>
        </nav>
      ...
      <div style={{ flex: 1, padding: '40px' }}>
        ...
        <p style={{ color: '#64748b', marginTop: '-10px', marginBottom: '30px' }}>Monitor account status and manage library access permissions.</p>
                ...
                members.map(m => (
                  <tr key={m.member_id} style={{ borderBottom: '1px solid #e2e8f0' }}>
                    <td style={{ padding: '15px' }}>
                      <span style={{ fontWeight: 'bold' }}>{m.first_name} {m.last_name}</span>
                      <br/>
                    ...
                    <td style={{ padding: '15px' }}>
                      <span style={{ 
                        ...
                        color: m.is_active ? '#15803d' : '#b91c1c', fontWeight: 'bold'
                      }}>
                    ...
                    <td style={{ padding: '15px', textAlign: 'right' }}>
                      <button 
                        ...
                        style={{ marginRight: '15px', color: '#0f172a', border: 'none', background: 'none', cursor: 'pointer', fontWeight: 'bold' }}
                      >
                        Edit
                      </button>
                      <button 
                        onClick={() => handleToggleStatus(m.member_id, m.is_active)} 
                        style={{ color: m.is_active ? '#dc2626' : '#10b981', border: 'none', background: 'none', cursor: 'pointer', fontWeight: 'bold', fontSize: '14px' }}
                      >
