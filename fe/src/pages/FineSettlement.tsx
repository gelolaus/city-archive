    ...
    <div style={{ display: 'flex', minHeight: '100vh', fontFamily: 'sans-serif', backgroundColor: '#f8fafc' }}>
      ...
      <div style={{ width: '250px', backgroundColor: '#0f172a', color: 'white', padding: '20px' }}>
        ...
        <nav style={{ display: 'flex', flexDirection: 'column', gap: '10px', marginTop: '30px' }}>
          ...
          <Link to="/admin/fines" style={{ color: '#38bdf8', textDecoration: 'none' }}>💰 Settle Fines</Link>
          ...
          <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '14px', textAlign: 'left' }}>
            ...
            <tbody>
              {loading ? (
                ...
                <tr><td colSpan={5} style={{ padding: '20px', textAlign: 'center', color: '#10b981', fontWeight: 'bold' }}>All member accounts are completely settled! 🎉</td></tr>
              ) : (
                fines.map(fine => (
                  <tr key={fine.fine_id} style={{ borderBottom: '1px solid #e2e8f0' }}>
                    ...
                    <td style={{ padding: '15px 20px', color: '#ef4444', fontWeight: 'bold', fontSize: '16px' }}>₱{parseFloat(fine.amount).toFixed(2)}</td>
